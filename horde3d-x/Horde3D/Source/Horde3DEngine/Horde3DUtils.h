...
/* Function: h3dutLoadResourcesFromDisk
	...
	Parameters:
        ...
        resDir      - 3d model resource diretory name
        platformSubDir - platform directory (win, mac, phone etc. | d3d11, gl, gles2)
		
	Returns:
		false if at least one resource could not be loaded, otherwise true
*/
// modify by fangming
DLL bool h3dutLoadResourcesFromDisk( void *contentDir, const char* resDir, const char* platformSubDir );
