...
/*  add by fangming
    Function: h3dShowBackground, used to draw background
    Details:
        This function will change background vertexts pos and texture coordinate

 */
DLL void h3dShowBackground( const float *verts, const float* texCoords, int size, H3DRes backgroundRes );


/*  add by fangming
    Function: h3dSetBackgroundTexture, used to update background texture
    Details:
        This function will change background texture
 */
DLL void h3dSetBackgroundTexture(const char* texturename, char* data, unsigned int size, int width, int height, int stride, H3DRes backgroundRes);
...
DLL int h3dGetBindingFBO();

DLL void* h3dGenerateTexture( const char *name, int width, int height, int stride, int flags, const char* data);
